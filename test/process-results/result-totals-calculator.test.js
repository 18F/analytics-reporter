  ...
  describe("calculateTotals(result)", () => {
    ...
    describe("when the report data is not empty", () => {
      ...
      it("should compute totals for device_models", () => {
        ...
        data.dimensionHeaders = [{ name: "date" }, { name: "mobileDeviceModel" }]
        data.metricHeaders = [{ name: "sessions" }]
        data.rows = [
          {
      ...
      it("should compute totals for screen-sizes", () => {
        ...
        data.dimensionHeaders = [{ name: "date" }, { name: "screenResolution" }]
        data.metricHeaders = [{ name: "sessions" }]
        data.rows = [
          {
      ...
      it("should compute totals for windows", () => {
        report.name = "windows"
        data.dimensionHeaders = [{ name: "date" }, { name: "operatingSystemVersion" }]
        data.metricHeaders = [{ name: "sessions" }]
        data.rows = [
          {
      ...
      it("should compute totals for os-browsers by operating system and browser", () => {
        ...
        data.dimensionHeaders = [{ name: "date" }, { name: "operatingSystem" }, { name: "browser" }]
        data.metricHeaders = [{ name: "sessions" }]
        data.rows = [
          {
            dimensionValues: [{ value: "20170130" }, { value: "Windows" }, { value: "Chrome" }],
            metricValues: [{ value: "100" }]
          },
          {
            dimensionValues: [{ value: "20170130" }, { value: "Windows" }, { value: "Firefox" }],
            metricValues: [{ value: "200" }]
          },
          {
            dimensionValues: [{ value: "20170130" }, { value: "Linux" }, { value: "Chrome" }],
            metricValues: [{ value: "300" }]
          },
          {
            dimensionValues: [{ value: "20170130" }, { value: "Linux" }, { value: "Firefox" }],
            metricValues: [{ value: "400" }]
          },
          {
            dimensionValues: [{ value: "20170130" }, { value: "Windows" }, { value: "Chrome" }],
      ...
      it("should compute totals for windows-browsers by windows version and browser version", () => {
        ...
        data.dimensionHeaders = [{ name: "date" }, { name: "operatingSystemVersion" }, { name: "browser" }]
        data.metricHeaders = [{ name: "sessions" }]
        data.rows = [
          {
            dimensionValues: [{ value: "20170130" }, { value: "XP" }, { value: "Chrome" }],
            metricValues: [{ value: "100" }]
          },
          {
            dimensionValues: [{ value: "20170130" }, { value: "XP" }, { value: "Firefox" }],
            metricValues: [{ value: "200" }]
          },
          {
            dimensionValues: [{ value: "20170130" }, { value: "Vista" }, { value: "Chrome" }],
            metricValues: [{ value: "300" }]
          },
          {
            dimensionValues: [{ value: "20170130" }, { value: "Vista" }, { value: "Firefox" }],
            metricValues: [{ value: "400" }]
          },
          {
            dimensionValues: [{ value: "20170130" }, { value: "XP" }, { value: "Chrome" }],
